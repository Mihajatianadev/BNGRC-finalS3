...
ALTER TABLE dons DROP FOREIGN KEY dons_ibfk_2; -- id_produit
ALTER TABLE dons DROP FOREIGN KEY dons_ibfk_3; -- id_ville
...
ALTER TABLE demandes DROP FOREIGN KEY demandes_ibfk_1; -- id_ville
ALTER TABLE demandes DROP FOREIGN KEY demandes_ibfk_2; -- id_produit
...
ALTER TABLE achats DROP FOREIGN KEY achats_ibfk_1; -- id_demande
ALTER TABLE achats DROP FOREIGN KEY achats_ibfk_2; -- id_ville
ALTER TABLE achats DROP FOREIGN KEY achats_ibfk_3; -- id_produit
ALTER TABLE achats DROP FOREIGN KEY achats_ibfk_4; -- id_user
